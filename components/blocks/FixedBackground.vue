...
export default {
  ...
  mounted() {
    ...
    var canvas = document.querySelector('#scenes');
...
var dotTexture = loader.load('https://tympanus.net/Development/DecorativeBackgrounds/img/dotTexture.png');
